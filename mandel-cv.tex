...
\item C.~Wang, J.~A.~Bendle,  H.~Yang, Y.~Yang, A.~Hardman, A.~Yamoah, A.~Thorpe, I.~Mandel, S.~E.~Greene, J.~Huang.  2021. Global calibration of novel 3-hydroxy fatty acid based temperature and pH proxies.  Geochimica et Cosmochimica Acta, accepted.
...
\item Rory Smith, Ssohrab Borhanian, Bangalore Sathyaprakash, Francisco Hernandez Vivanco, Scott Field, Paul Lasky, Ilya Mandel, Soichiro Morisaki, David Ottaway, Bram Slagmolen, Eric Thrane, Daniel T\"{o}yr\"{a}, Salvatore Vitale.  2021.  Bayesian inference for gravitational waves from binary neutron star mergers in third-generation observatories.  arXiv:2103.12274
