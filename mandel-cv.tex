...
Grant reviewer for NASA (USA), NSF (USA), Hungarian Scientific Research Fund, STFC (UK), NWO (Netherlands Organisation for Scientific Research), European Research Council, CONICYT (Chile), ARC (Australia), CRC (Canada) (2008--current)\\
...
Co-chair, EAS session ``Where are the BH-NS binaries?'' (2021)
...
Thillai Saravanan (2020), the impact of initial conditions on binary evolution\\
...
\item Y.~Eley, W.~Thompson, S.~Greene, I.~Mandel, K.~Edgar, J.~Bendle, and T.~Dunkley Jones.  2020.  OPTiMAL: A new machine learning approach for GDGT-based palaeothermometry.  Climate of the Past 16, 2599.  \url{https://cp.copernicus.org/preprints/cp-2019-60/}
...
\item I.~Mandel, B.~M\"{u}ller, J.~Riley, S.~E.~de Mink, A.~Vigna-Gomez, D.~Chattopadhyay. 2020.  Binary population synthesis with probabilistic remnant mass and kick prescriptions. MNRAS 500, 1380.   arXiv:2007.03890

\item L.~du Buisson, P.~Marchant, P.~Podsiadlowski, C.~Kobayashi, F.~B.~Abdalla, P.~Taylor, I.~Mandel, S.~E.~de Mink, T.~J.~Moriya, N.~Langer.  2020. Cosmic Rates of Black Hole Mergers and Pair-Instability Supernovae from Chemically Homogeneous Binary Evolution. MNRAS, accepted.  arXiv:2002.11630
...
\item L.~Lin, D.~Bingham, F.~Broekgaarden, I.~Mandel. Uncertainty quantification of a computer model for binary black hole formation. 2021. Submitted to Annals of Applied Statistics.

\item D.~Psaltis, C.~Talbot, E.~Payne, I.~Mandel.  2021. Probing the black hole metric. I. Black hole shadows and binary black-hole inspirals.  arXiv:2012.02117

\item C.~Wang, J.~A.~Bendle,  H.~Yang, Y.~Yang, A.~Hardman, A.~Yamoah, A.~Thorpe, I.~Mandel, S.~E.~Greene, J.~Huang.  2021. Global calibration of novel 3-hydroxy fatty acid based temperature and pH proxies.  Submitted to Geochimica et Cosmochimica Acta

\item J.~Riley, I.~Mandel, P.~Marchant, E.~Butler, K.~Nathaniel, C.~Neijssel, S.~Shortt, A.~Vigna-Gomez.  2021. Chemically Homogeneous Evolution: A rapid population synthesis approach. arXiv:2010.00002
...
1/2021 Colloquium on ``The promise of gravitational-wave astrophysics'' at UCLA
...
12/2020	AIP Victoria Nobel Lecture
...
1/2021	Subject of ``Past (more) perfect'', Comsos magazine, \url{https://cosmosmagazine.com/history/palaeontology/past-more-perfect}
